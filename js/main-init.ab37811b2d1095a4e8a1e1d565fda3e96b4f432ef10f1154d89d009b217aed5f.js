(() => {
  // ns-params:@params
  var params_default = { baseURL: "/fantastic-barnacle/" };

  // ns-hugo:/tmp/hugo_cache_runner/modules/filecache/modules/pkg/mod/github.com/razonyang/hugo-theme-bootstrap@v1.8.3/assets/js/local-storage/index.ts
